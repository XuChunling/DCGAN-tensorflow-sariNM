...
flags.DEFINE_float("G_rate", 2, "generator learning rate is default twice as much as learning rate of for adam [2]")#modify by jiangdh
...
def main(_):
  ...
  if FLAGS.out_name == "":
      ...
      if FLAGS.train:
        FLAGS.out_name += '-x{}.z{}.{}.y{}.b{}'.format(FLAGS.input_height, FLAGS.learning_rate, FLAGS.z_dist, FLAGS.G_num, FLAGS.batch_size) # modify by jiangdh, add learning_rate
